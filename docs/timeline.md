...
## Week 11–16 (4/28–6/8) — 期中考後衝刺

⚠ 詳細計畫（每週每人任務、Quality Gate、QCQA 清單、風險緩衝）請見 **[`post_midterm_plan.md`](./post_midterm_plan.md)**

### 週主題摘要

| 週 | 日期 | 課程週次 | 專案里程碑 |
|---|------|---------|----------|
| 11 | 4/28–5/4 | 專案資源與成本 / 作業5完成 | **Core 1 端到端**（後端骨架 + AI 生成） |
| 12 | 5/5–5/11 | 專案計畫 / 作業6公布 | **Core 2 完成**（行程編輯器 ↔ API） |
| 13 | 5/12–5/18 | PM 枚角 I | **Core 3 + XAI 三層完整** |
| 14 | 5/19–5/25 | PM 枚角 II / 作業6完成 | **Plus 擇一 + 作業6** |
| 15 | 5/26–6/1 | No Class（衝刺週） | **部署 + QCQA + 報告初稿** |
| 16 | 6/2–6/8 | **6/8 期末展示** | 彩排 ×2 + Demo |

### 🎯 6/8 期末展示要交
1. 課堂 Demo + 簡報（15 分鐘）
2. 期末報告（含可編輯檔）→ NTU Cool
